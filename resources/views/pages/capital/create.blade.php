...
@csrf
    <div class="row mb-3">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control cm @error('name') is-invalid @enderror" placeholder="Enter dose name" name="name" value="{{ old('name') }}">
        </div>
        <div class="col-md-6">
            <label for="" class="form-label cm">Cost</label>
            <input type="number" class="form-control cm @error('amount') is-invalid @enderror" placeholder="Enter dose name" name="amount" value="{{ old('amount') }}">
        </div>
    </div>
