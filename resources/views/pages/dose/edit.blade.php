...
<div class="add-heading">
    <h3 class="heading-cm"> 
        <a href="{{ route('dose.index')}}" class="nav-icon me-2">
            <i class="fa-solid fa-angle-left"></i> 
        </a>
        Product Details<span class="sub-nav ms-2" > > Dose > Edit</span>
    </h3>
</div>
...
<div class="form-cm">
    ...
    <div class="row">
        <div class="col-md-3">
            <h3 class="create-form-heading">Edit Dose</h3>
            <form action="{{ route('dose.update', $dose) }}" method="post">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <div class="col-md-12">
                        <label for="" class="form-label cm">Dose Name</label>
                        <input type="text" class="form-control cm" placeholder="Enter product dose" name="name" value="{{ $dose->name }}">
                    </div>
                </div>
