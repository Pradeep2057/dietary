...
<div class="add-heading">
    <h3 class="heading-cm"> 
        ...
        Product Details<span class="sub-nav ms-2" > > Type</span>
    </h3>
</div>
...
<div class="form-cm">
    ...
    <div class="row">
        <div class="col-md-3">
            <h3 class="create-form-heading">Create Product Type</h3>
            <form action="{{ route('type-of-product.store') }}" method="POST">
                @csrf
                <div class="row mb-3">
                    <div class="col-md-12">
