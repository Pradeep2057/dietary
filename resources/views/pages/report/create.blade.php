...
<form action="{{ route('report.store') }}" method="POST" class="form-cm">
    ...
    <div class="row mb-3">
        <div class="col-md-4">
            ...
            <select class="form-select kit-form-control mySelect @error('product_id') is-invalid @enderror"
                name="product_id" aria-label="Default select example" value="{{ old('product_id') }}">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control cm @error('application_number') is-invalid @enderror"
                placeholder="Enter application number and date" name="application_number" value="{{ old('application_number') }}">
        </div>
        <div class="col-md-4">
            ...
            <input type="text" class="form-control cm date-picker @error('date_of_grant') is-invalid @enderror"
                data-single="1" placeholder="Select Date" name="date_of_grant" value="{{ old('date_of_grant') }}">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-4">
            ...
            <input type="text" class="form-control cm date-picker @error('validity_from') is-invalid @enderror"
                data-single="1" placeholder="Select Date" name="validity_from" value="{{ old('validity_from') }}">
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control cm date-picker @error('validity_to') is-invalid @enderror"
                data-single="1" placeholder="Select Date" name="validity_to" value="{{ old('validity_to') }}">
        </div>
        <div class="col-md-4">
            ...
            <input type="date" class="form-control cm @error('gmp_validity') is-invalid @enderror"
                placeholder="Select Date" name="gmp_validity" value="{{ old('gmp_validity') }}">
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-md-4">
            ...
            <input type="text" class="form-control cm @error('prepared_by') is-invalid @enderror"
                placeholder="Enter Prepared By" name="prepared_by" value="{{ old('prepared_by') }}">
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control cm date-picker @error('date_of_preparation') is-invalid @enderror"
                data-single="1" placeholder="Select Date" name="date_of_preparation" value="{{ old('date_of_preparation') }}">
        </div>
    </div>
    ...
    @if(Auth::user()->role==2)
    <div class="row">
        <div class="col-md-12 text-end"><button type="submit" name="approval" class="btn btn-primary">Send for approval</button></div>
    </div>
    @endif
