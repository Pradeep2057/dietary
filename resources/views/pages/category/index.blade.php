...
<div class="add-heading">
    <h3 class="heading-cm"> 
        ...
        Product Details<span class="sub-nav ms-2" > > Category</span>
    </h3>
</div>
...
<div class="form-cm">
    ...
    <div class="row">
        <div class="col-md-3">
            <h3 class="create-form-heading">Create Category</h3>
            <form action="{{ route('category.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control cm" placeholder="Enter remarks" name="remarks">
                    </div>
                </div>
