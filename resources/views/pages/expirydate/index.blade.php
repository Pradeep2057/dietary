...
<div class="form-cm">
    ...
    <div class="row">
        <div class="col-md-3">
            <h3 class="create-form-heading">Expiry Date</h3>
            <form action="{{ route('expirydate.store') }}" method="POST">
                @csrf
                <div class="row mb-3">
                    <div class="col-md-12">
                        <label for="" class="form-label cm">Expiry Date</label>
                        <input type="text" class="form-control cm @error('name') is-invalid @enderror" placeholder="Enter expiry date" name="name">
                    </div>
                </div>
