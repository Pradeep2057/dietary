...
<div class="add-heading">
    <h3 class="heading-cm"> 
        <a href="{{ route('size.index')}}" class="nav-icon me-2">
            <i class="fa-solid fa-angle-left"></i> 
        </a>
        Product Details<span class="sub-nav ms-2" > > Size > Edit</span>
    </h3>
</div>
            ...
            <form action="{{ route('size.update', $size) }}" method="post">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control cm" placeholder="Enter product size" name="name" value="{{ $size->name }}">
                    </div>
                </div>
