...
<div class="add-heading">
    <h3 class="heading-cm"> 
        <a href="{{ route('form-of-product.index')}}" class="nav-icon me-2">
            <i class="fa-solid fa-angle-left"></i> 
        </a>
        Product Details<span class="sub-nav ms-2" > > Form > Edit</span>
    </h3>
</div>
...
<div class="form-cm">
    ...
    <div class="row">
        <div class="col-md-3">
            <h3 class="create-form-heading">Edit Product Form</h3>
            <form action="{{ route('form-of-product.update', $productform) }}" method="post">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <div class="col-md-12">
                        <label for="" class="form-label cm">Product Form Name</label>
                        <input type="text" class="form-control cm" placeholder="Enter Product Form Name" name="name" value="{{ $productform->name }}">
                    </div>
                </div>
